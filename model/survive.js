...
[
    ...
    { description: "Be adaptable", scene: "leave"}
])

scenes.createScene("stay", 
`You stay in your house no matter what. When local authorities come to evacuate, you say "I was born here and I'll die here". Frustrated, the local authorities leave you there. The fire starts getting big and ends up killing you. GAME OVER!!!`)

scenes.createScene("leave", 
`You have decided to abandon your home. But you are optimistic. You pack up your stuff and now decide how you want to make your journey`,
[
...
`As you continue to walk towards the nearby town, you come across a pack of wolves. They have smelled your scent. You try to hide and run, but without luck. The pack of wolves find you and kill you. GAME OVER!!!`)
...
`The food is not really appetizing but it will do when you're this hungry. With your stomach somewhat full, you continue along the journey. Not surprisingly, after some time pedaling, you start feeling a little sick. The day starts getting dark and you come across an abandoned warehouse. It's not in the best shape and could collapse any moment. As the sun begins to set, the temperature drops and it can get really windy and cold. You have yet another important decision to make.`,
[
    { description: "Take refuge in a structurally unstable building", scene: "warehouse"},
    { description: "Sleep outdoors in a sub-zero temperature", scene: "outdoors"},
])

scenes.createScene("pass", 
`You say to yourself that this is not edible and maybe there is another store along the road. As you continue your journey, you never find another store. You are not only starving but also exhausted. You park your bike and try to get some sleep. Next morning, you see there are some wild berries. You have been hungry for a long time.`
,
[
...
scenes.createScene("warehouse", 
`Despite a questionable structural stability, you decide to take this risk rather than sleeping outside in the cold. While you're sleeping, the wind picks up and becomes a big storm. Just when you think you made a better decision, the storm turns out to be the catalyst for shaking the builing. A tree falls over the building and that does it. The building collapses and now you're dead. GAME OVER!!!`)
